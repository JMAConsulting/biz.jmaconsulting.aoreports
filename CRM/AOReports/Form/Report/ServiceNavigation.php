...
class CRM_AOReports_Form_Report_ServiceNavigation extends CRM_AOReports_Form_Report_FamiliesServed {
  ...
  function from() {
    ...
    $this->_from = " FROM civicrm_contact {$this->_aliases['civicrm_contact']}
      INNER JOIN {$tableName} temp ON temp.lead_family_member_id = {$this->_aliases['civicrm_contact']}.id
      INNER JOIN civicrm_value_donation_cust_2 lang ON lang.entity_id = temp.lead_family_member_id AND lang.language_10 IS NOT NULL
    ";
  }
